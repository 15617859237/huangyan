            ...
            <div id="mws-login-form">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="mws-form-row">
                     ...
                     <div class="mws-form-row">
                        <div class="mws-form-item">
							<font color="#fff" size='4'>验证码:</font>
                            <input type="text" name="code" class="required" placeholder="验证码" style="width:100px">
                            <img src="/code"  title="点击切换" onclick="this.src=this.src+'?a='+Math.random()">
                        </div>
                    </div>
